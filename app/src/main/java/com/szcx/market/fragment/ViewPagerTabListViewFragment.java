...
//                try {
//                    MarketApplication.getDownloadManager().addNewDownload(ApiHelper.getDownUrl(app.getId()), app.getName(), target, true, true, app.getIcon(), app.getVer(),app.getId(),
...
//        }
        ...
        String target = "/sdcard/xUtils/" + System.currentTimeMillis() + app.getName() + ".apk";
        try {
            MarketApplication.getDownloadManager().addNewDownload(ApiHelper.getDownUrl(app.getId()), app.getName(), target, true, true,
                    new DownloadRequestCallBack());
//            MarketApplication.getDownloadManager().addNewDownload(ApiHelper.getDownUrl(app.getId()), app.getName(), target, true, true, app.getIcon(), app.getVer(), app.getId(),
//                    new DownloadRequestCallBack());
        } catch (DbException e) {
