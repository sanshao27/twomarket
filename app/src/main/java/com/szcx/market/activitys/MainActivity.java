...
public class MainActivity extends BaseActivity implements ObservableScrollViewCallbacks {
    ...
    public static class SimpleRecyclerAdapter extends RecyclerView.Adapter<SimpleRecyclerAdapter.ViewHolder> {
